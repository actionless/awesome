...
-- <tr>
--     <td>text_color</td>
--     <td>theme_text_color</td>
--     <td></td>
--     <td></td>
--     <td>Entry fg</td>
-- </tr>
-- <tr>
--     <td>button_bg_color</td>
--     <td>theme_buton_bg_color</td>
--     <td>theme_bg_color</td>
--     <td></td>
--     <td>Button bg</td>
-- </tr>
...
--     <td>theme_button_fg_color</td>
--     <td>theme_fg_color</td>
--     <td></td>
--     <td>Button fg</td>
-- </tr>
-- <tr>
--     <td>button_border_color</td>
--     <td></td>
--     <td></td>
--     <td></td>
...
-- </tr>
-- <tr>
--     <td>button_border_width</td>
--     <td></td>
--     <td></td>
--     <td></td>
--     <td>Button border-top-width</td>
-- </tr>
-- <tr>
--     <td>selected_bg_color</td>
--     <td>theme_selected_bg_color</td>
--     <td></td>
--     <td></td>
--     <td>ToggleButton bg</td>
-- </tr>
-- <tr>
--     <td>selected_fg_color</td>
--     <td>theme_selected_fg_color</td>
--     <td></td>
--     <td></td>
--     <td>ToggleButton fg</td>
-- </tr>
-- <tr>
--     <td>menubar_bg_color</td>
--     <td>menubar_bg_color</td>
--     <td>theme_bg_color</td>
--     <td></td>
--     <td>HeaderBar bg</td>
...
-- </tr>
-- <tr>
--     <td>header_button_bg_color</td>
--     <td>header_button_bg_color</td>
--     <td>menubar_bg_color</td>
--     <td>theme_bg_color</td>
--     <td>HeaderBar > Button bg</td>
-- </tr>
-- <tr>
--     <td>header_button_fg_color</td>
--     <td>header_button_fg_color</td>
--     <td>menubar_fg_color</td>
--     <td>theme_fg_color</td>
--     <td>HeaderBar > Button fg</td>
-- </tr>
-- <tr>
--     <td>header_button_border_color</td>
--     <td></td>
--     <td></td>
--     <td></td>
--     <td>HeaderBar > Button border-color</td>
-- </tr>
-- <tr>
--     <td>error_color</td>
--     <td>error_color</td>
--     <td>error_bg_color</td>
--     <td></td>
--     <td>destructive Button bg</td>
-- </tr>
-- <tr>
--     <td>error_bg_color</td>
--     <td>error_bg_color</td>
...
-- </tr>
-- <tr>
--     <td>error_fg_color</td>
--     <td>error_fg_color</td>
--     <td>theme_selected_fg_color</td>
--     <td></td>
--     <td>destructive Button fg</td>
-- </tr>
-- <tr>
--     <td>warning_color</td>
--     <td>warning_color</td>
--     <td>warning_bg_color</td>
--     <td></td>
--     <td></td>
-- </tr>
-- <tr>
...
-- </tr>
-- <tr>
--     <td>tooltip_bg_color</td>
--     <td>theme_tooltip_bg_color</td>
--     <td>theme_bg_color</td>
--     <td></td>
--     <td></td>
-- </tr>
-- <tr>
--     <td>tooltip_fg_color</td>
--     <td>theme_tooltip_fg_color</td>
--     <td>theme_fg_color</td>
--     <td></td>
--     <td></td>
-- </tr>
...
-- </tr>
-- <tr>
--     <td>osd_border_color</td>
--     <td>osd_borders_color</td>
--     <td>osd_fg_color</td>
--     <td></td>
--     <td></td>
-- </tr>
...
-- </tr>
-- <tr>
--     <td>wm_border_focused_color</td>
--     <td>wm_border_focused</td>
--     <td>theme_selected_bg_color</td>
--     <td></td>
--     <td>ToggleButton bg</td>
-- </tr>
-- <tr>
--     <td>wm_border_unfocused_color</td>
--     <td>wm_border_unfocused</td>
--     <td>wm_border</td>
--     <td>menubar_bg_color</td>
--     <!--<td>theme_bg_color</td>-->
--     <td>HeaderBar bg</td>
-- </tr>
-- <tr>
--     <td>wm_title_focused_color</td>
--     <td>wm_title_focused</td>
--     <td>wm_title</td>
--     <td>theme_selected_fg_color</td>
--     <td>ToggleButton fg</td>
-- </tr>
-- <tr>
--     <td>wm_title_unfocused_color</td>
--     <td>wm_title_unfocused</td>
--     <td>wm_unfocused_title</td>
--     <td>menubar_fg_color</td>
--     <!--<td>theme_fg_color</td>-->
--     <td>HeaderBar fg</td>
-- </tr>
-- <tr>
--     <td>wm_icons_focused_color</td>
--     <td>wm_icons_focused</td>
--     <td>wm_title_focused</td>
--     <td>theme_selected_fg_color</td>
--     <td>ToggleButton fg</td>
-- </tr>
-- <tr>
--     <td>wm_icons_unfocused_color</td>
--     <td>wm_icons_unfocused</td>
--     <td>wm_title_unfocused</td>
--     <td>menubar_fg_color</td>
--     <!--<td>theme_fg_color</td>-->
--     <td>HeaderBar fg</td>
