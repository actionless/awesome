...
attach = function(d, position_f, args)
    ...
    -- Note that tacking the mouse is not supported
...
local function get_relative_regions(geo, mode, is_absolute)
    ...
    elseif is_absolute then
        -- Some signals are a bit inconsistent between inconsistent in their
        -- arguments convention. This little hack to mitigate the issue.
